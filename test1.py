...
#      .format("kafka") \
#      .option("kafka.bootstrap.servers", "localhost:9092,localhost:2181") \
#      .option("subscribePattern", "json1") \
#      .option("startingOffsets", "earliest") \
#      .option("endingOffsets", "latest") \
#      .load()
df = spark.read.format("kafka").option("kafka.bootstrap.servers", "localhost:9092,localhost:2181").option("subscribe", "json1").load()
